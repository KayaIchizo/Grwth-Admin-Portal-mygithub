                        ...
                        <Item>
                            ...
                            <Box sx={{ display: 'flex', justifyContent: 'space-evenly', alignItems: 'center', mt: 1.5, }}>
                                <Box sx={{ display: 'flex', justifyContent: 'space-evenly', alignItems: 'center' }}>
                                    ...
                                    <Typography sx={{ backgroundColor: "#ffaadd", color: "black", borderRadius: "50%", width: "40px", height: "40px", padding: "12px", fontFamily: "bold", mr: 2, fontWeight: 900 }}> {JSON.parse(localStorage.getItem('userinfo'))[0]} </Typography>
                                ...
                                <Box sx={{ display: "flex", alignItems: "center" }}>
                                    ...
                                    >
                                        ...
                                        <MenuItem sx={{ "&:hover": { color: "white", backgroundColor: "#2CC5CE" }, color: "#2CC5CE" }} onClick={handleShareOpen}>Share</MenuItem>
                                        <MenuItem
                                            // onClick={() => {
                                            //  rowdelete(row.title)
                                            // }}
                                        ...
                                        <MenuItem sx={{ "&:hover": { color: "white", backgroundColor: "#2CC5CE" }, color: "#2CC5CE" }} onClick={() => { handleDownload(onedata, `${onedata.title}.csv`) }}>Download</MenuItem>
